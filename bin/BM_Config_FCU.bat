...
set BIN_location=C:\src\ip-vav\master\in4ps-firmware.build\in4ps-firmware.AL_FCU.IP.FreeRTOS.RelWithDebInfo.arm_gnu\
set BIN_name=in4ps-firmware
::ECC signing certificate info
set project_name=ALERTONFCU
set ecc_signing_certificate_file=C:\Code_Signing\FCU\AlertonFCU_SHA256.crt
set ecc_signing_worker_name=AlertonFCU_SHA256
set ecc_signing_fixture_name=FC_FCUAlr
::CST certificate info
set SigningCertificate=C:\Code_Signing\FCU\AlertonFCU_RSA.pem
set FixtureCertificate=CurrentUser\MY\69eb3e22874120a19e1a15662fc9bf3b7e0b6984
set WorkerName=AlertonFCU_RSA
::AppKicker
set AppKicker=app_kicker_FCU.out
set fwversion=v1.9.2.4
